...
2. **Model Quantization** ✅ **COMPLETED** (INT8)
   ...
   - Script: `tooling/quantize-yolo-world.py`
   - Output: `tooling/model-labels/yolov8s-worldv2-int8.onnx`
...
1. **Upload Quantized Model** ❌ **BLOCKED: AUTH REQUIRED**
   ...
   - Then upload: `gcloud storage cp tooling/model-labels/yolov8s-worldv2-int8.onnx gs://widowmaker-site-images/models/yolo_world_household_v2_int8.onnx`
...
python tooling/export-yolo-world.py
...
See `docs/notes/web-worker-implementation.md` for complete implementation guide.
...
python -m onnxruntime.quantization.preprocess \
  --input tooling/model-labels/yolov8s-worldv2.onnx \
  --output tooling/model-labels/yolov8s-worldv2-int8.onnx

# Or quantize to FP16
python -m onnxruntime.tools.convert_onnx_models_to_ort \
  --model_path tooling/model-labels/yolov8s-worldv2.onnx \
  --output_dir . \
...
1. **Upload quantized model to GCS**:
   ...
   # Upload INT8 model
   gcloud storage cp tooling/model-labels/yolov8s-worldv2-int8.onnx \
