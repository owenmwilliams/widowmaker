...
<template>
  ...
  <q-dialog v-model="addLocationDialog" persistent>
    <DesktopAdd :user="props.user!" addType="Location" />
  </q-dialog>

  <q-dialog v-model="addCollectionDialog" persistent>
    <DesktopAdd :user="props.user!" addType="Collection" />
  </q-dialog>

  <q-dialog v-model="addContainerDialog" persistent>
    <DesktopAdd :user="props.user!" addType="Container" />
  </q-dialog>
  ...
  <q-dialog dark v-model="editContainerDialog" persistent>
    <DesktopEdit :user="props.user!" addType="Container" />
  </q-dialog> -->
</template>
