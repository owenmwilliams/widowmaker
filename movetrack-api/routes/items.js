...
const { QR_TYPES, buildQrUrl, generateUniqueToken, extractQrToken } = require('../services/primitives/qrService');
const { generateItemEstimate } = require('../services/primitives/itemEstimationService');
