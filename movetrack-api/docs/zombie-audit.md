...
> Written: 2025-04-01 | Status: **Done** | Audited during `refactor/api-folder-structure`
...
| `routes/experimental/visionLabVideo.js` | 1 (app.js import + mount) | Frontend `VisionLabVideo.vue` uses `/admin/vision-lab-video/*` endpoints. Linked from MobileSettings. |
