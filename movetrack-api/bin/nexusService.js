...
const toolDeclarations = [
  {
    ...
    parameters: {
      ...
      properties: {
        name:           { type: FunctionDeclarationSchemaType.STRING, description: 'Descriptive item name, e.g. "Queen Bed Frame", "55-inch TV"' },
        room_name:      { type: FunctionDeclarationSchemaType.STRING, description: 'Room name this item belongs to, e.g. "Master Bedroom", "Living Room"' },
        quantity:       { type: FunctionDeclarationSchemaType.INTEGER, description: 'How many. Default 1.' },
        description:    { type: FunctionDeclarationSchemaType.STRING, description: 'Brief description' },
        weight_lbs:     { type: FunctionDeclarationSchemaType.NUMBER, description: 'Estimated weight in pounds' },
        length_in:      { type: FunctionDeclarationSchemaType.NUMBER, description: 'Length in inches' },
        width_in:       { type: FunctionDeclarationSchemaType.NUMBER, description: 'Width in inches' },
        height_in:      { type: FunctionDeclarationSchemaType.NUMBER, description: 'Height in inches' },
        fragile:        { type: FunctionDeclarationSchemaType.BOOLEAN, description: 'Whether item is fragile' },
        material:       { type: FunctionDeclarationSchemaType.STRING, description: 'Primary material (wood, metal, glass, etc.)' },
        primary_color:  { type: FunctionDeclarationSchemaType.STRING, description: 'Primary color' },
        tags:           { type: FunctionDeclarationSchemaType.ARRAY, items: { type: FunctionDeclarationSchemaType.STRING }, description: 'Tags like "Fragile", "Heavy", "Antique"' },
        estimated_value: { type: FunctionDeclarationSchemaType.NUMBER, description: 'Estimated dollar value' },
        notes:          { type: FunctionDeclarationSchemaType.STRING, description: 'Notes like "requires disassembly", "heavy"' },
        confidence:     { type: FunctionDeclarationSchemaType.NUMBER, description: 'Confidence 0.0-1.0 that this item exists and details are accurate' },
      },
  ...
  },
  {
    ...
    parameters: {
      type: FunctionDeclarationSchemaType.OBJECT,
      properties: {
        name:        { type: FunctionDeclarationSchemaType.STRING, description: 'Room name, e.g. "Kitchen", "Master Bedroom"' },
        description: { type: FunctionDeclarationSchemaType.STRING, description: 'Brief description of the room' },
      },
      required: ['name'],
    },
  },
  ...
  },
  {
    ...
    parameters: {
      type: FunctionDeclarationSchemaType.OBJECT,
      properties: {
        home_type:      { type: FunctionDeclarationSchemaType.STRING, description: 'e.g. "apartment", "house", "studio"' },
        bedroom_count:  { type: FunctionDeclarationSchemaType.INTEGER, description: 'Number of bedrooms' },
        bathroom_count: { type: FunctionDeclarationSchemaType.INTEGER, description: 'Number of bathrooms' },
      },
    },
  },
  {
    ...
    parameters: {
      type: FunctionDeclarationSchemaType.OBJECT,
      properties: {
        file_url:  { type: FunctionDeclarationSchemaType.STRING, description: 'GCS URL of the uploaded photo' },
        mime_type: { type: FunctionDeclarationSchemaType.STRING, description: 'MIME type, e.g. "image/jpeg"' },
        room_hint: { type: FunctionDeclarationSchemaType.STRING, description: 'Which room this photo is from, if known' },
      },
  ...
  },
  {
    ...
    parameters: {
      type: FunctionDeclarationSchemaType.OBJECT,
      properties: {
        item_id:     { type: FunctionDeclarationSchemaType.STRING, description: 'The ID of the item to update' },
        name:        { type: FunctionDeclarationSchemaType.STRING },
        description: { type: FunctionDeclarationSchemaType.STRING },
        quantity:    { type: FunctionDeclarationSchemaType.INTEGER },
        weight_lbs:  { type: FunctionDeclarationSchemaType.NUMBER },
        fragile:     { type: FunctionDeclarationSchemaType.BOOLEAN },
  ...
  },
  {
    ...
    parameters: {
      type: FunctionDeclarationSchemaType.OBJECT,
      properties: {
        first_name: { type: FunctionDeclarationSchemaType.STRING, description: 'First name' },
        last_name:  { type: FunctionDeclarationSchemaType.STRING, description: 'Last name' },
        goal:       { type: FunctionDeclarationSchemaType.STRING, description: 'One of: move, organize, insurance, multi_home' },
      },
    },
  },
  {
    ...
    parameters: {
      type: FunctionDeclarationSchemaType.OBJECT,
      properties: {
        name:    { type: FunctionDeclarationSchemaType.STRING, description: 'Location name, e.g. "My Apartment", "Home"' },
        address: { type: FunctionDeclarationSchemaType.STRING, description: 'Street address' },
        city:    { type: FunctionDeclarationSchemaType.STRING, description: 'City' },
        state:   { type: FunctionDeclarationSchemaType.STRING, description: 'State abbreviation' },
        zip:     { type: FunctionDeclarationSchemaType.STRING, description: 'ZIP code' },
      },
      required: ['name'],
    },
  },
