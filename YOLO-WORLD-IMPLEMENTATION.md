...
Full list: See `scripts/export-yolo-world.py` or `movetrack-app/src/utils/detectors.ts`
...
### New Files
- `scripts/export-yolo-world.py` - Python export script
- `yolov8s-worldv2.onnx` - Generated model file (49MB)
- `household_items.json` - Vocabulary manifest
- `YOLO-WORLD-IMPLEMENTATION.md` - This file
